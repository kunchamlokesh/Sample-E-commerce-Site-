	...
	while($row_pro=mysqli_fetch_array($run_cop)){
		...
		echo "
				<div id='single_product'>
					...
					<a href='details.php?c_id=$prod_id' style='float:left;' align='center'><img src='admin_area/coupon_images/$prod_image' width='180' height='180'/></a>
					
					<p><b> $prod_price % DISCOUNT</b></p>
					<a href='details.php?c_id=$prod_id' style='float:left;' align='center'>DETAILS</a>
